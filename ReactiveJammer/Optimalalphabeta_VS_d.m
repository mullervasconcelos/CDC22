%% Optimal jamming probabilities alpha* and beta* as a function of d
...
for i=1:n
    ...
    while flag==0
        ...
        flag=((Delta1<=10^-4)&&(Delta2<=10^-4)); % Check whether this is a epsilon first nash equilibrium
...
set(gca,'xtick',[0.5:0.5:5],'ytick',[0:0.1:1])
